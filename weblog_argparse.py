...
def main():
    parser = argparse.ArgumentParser(description="Blog application")
    parser.add_argument("action", choices=["register", "login", "search", "create", "delete", "edit", "show"], help="Action to perform")
